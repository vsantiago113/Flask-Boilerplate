...
class User(UserMixin, database.Model):
    ...
    confirmed_at = database.Column(database.DateTime, default=datetime.now)
    first_name = database.Column(database.String(50), nullable=False, default="")
    last_name = database.Column(database.String(50), nullable=False, default="")
    user_title = database.Column(database.String(50), nullable=False, default="")
    image_name = database.Column(database.String(128), default="")
